    ...
    <view class="about">
        ...
        <view class="cover">
            <view class="name-tags-log">
                ...
                >
                <view class="subitem">
                    <AtBadge :dot="haveUpdate">
                        <AtButton class="updateLog" size="small" text
                            >更新日志</AtButton
                        >
                    </AtBadge>
                </view>
        ...
        <view class="at-article">
            <view class="at-article__h2">简介</view>
            <view class="at-article__content">
                <view class="at-article__p">
                    带着这些问题，我们来审视一下南寻。 既然如此，
                    对我个人而言，南寻不仅仅是一个重大的事件，还可能会改变我的人生。
                    可是，即使是这样，南寻的出现仍然代表了一定的意义。
                    迈克尔·F·斯特利在不经意间这样说过，最具挑战性的挑战莫过于提升自我。
                    这启发了我。就我个人来说，南寻对我的意义，不能不说非常重大。
                    南寻，到底应该如何实现。
                    了解清楚南寻到底是一种怎么样的存在，是解决一切问题的关键。
                    既然如此，
        ...
        <view class="developer">
            <view class="at-article">
                <view class="at-article__h2">和开发者交朋友</view>
            </view>
            <image
                mode="aspectFill"
                v-for="{ name, src } in developerImages"
                :src="src"
                :key="name"
            ></image>
        </view>
...
<script>
// 按需引入, 更小的应用体积
import { AtButton, AtToast, AtNoticebar, AtTag, AtBadge } from "taro-ui-vue";
...
export default {
    ...
    data() {
        return {
            msg: "Hello world!",
            show: false,
            logoSrc:"../../../images/more/logo.png",
            titleSrc:"../../../images/more/title.png",
            coverSrc:
