<template>
    <view class="form-box">
        ...
        <AtForm>
            ...
            <view class="at-row at-row__align--center at-row__justify--center buttonView">
                ...
                <view class="at-col at-col-6 at-col__offset-1">
                  ...
                  <view class="post-title" style="text-align:center;font-size:18px;">发布</view>
            ...
            <view class="panel">
              ...
              <view class="panel__content">
                <picker mode="selector" :range="tags" :value="selectedTagIndex" 
                  @change="handleChange"
                  @cancel="handleCancel">

                  <view class="selector-item">
                  <view class="selector-item__label">发布类型</view>
                  <view class="selector-item__value">{{tags[selectedTagIndex]}}</view>
                  </view>
                </picker>
              </view>
            </view>
